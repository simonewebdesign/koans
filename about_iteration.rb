...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # #inject injects an item into an array and then makes an operation with each
    # item. Finally returns the result of that operation.
    # The particularity is that, in every single iteration, it passes a 
    # precedently memorized value.
  end
  ...
  # We did it that way because we didn't need to store the file. 
